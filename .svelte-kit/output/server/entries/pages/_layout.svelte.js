import { s as setContext, g as getContext, a as split_css_unit, c as create_ssr_component, e as escape, b as add_attribute, d as compute_slots, f as add_styles, h as validate_store, i as subscribe, j as createEventDispatcher, k as spread, l as escape_object, v as validate_component, m as missing_component, n as each } from "../../chunks/ssr.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let $toastSettings, $$unsubscribe_toastSettings;
  ...
  $$unsubscribe_toastSettings = subscribe(toastSettings, (value) => $toastSettings = value);
  initializeStores();
  getToastStore();
  getModalStore();
  $$unsubscribe_isApplicationIdle();
  $$unsubscribe_toastSettings();
  return `${validate_component(Modal, "Modal").$$render($$result, {}, {}, {})} ${validate_component(Toast, "Toast").$$render($$result, { background: $toastSettings.background }, {}, {})}  ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    default: () => {
      return `${slots.header ? slots.header({}) : `  ${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        trail: () => {
          return `<button class="btn btn-sm variant-ghost-surface" data-svelte-h="svelte-1yof3ab">Configurations</button> `;
        },
        lead: () => {
          return `<strong class="text-xl" data-svelte-h="svelte-11wwk2">1xBet Watcher v1.0</strong>`;
        }
