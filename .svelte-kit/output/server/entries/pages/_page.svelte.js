...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function notifyCallback(match, betData, matchTime) {
    ...
    Total: ${betData.total.lines} line ${betData.total.blocked ? "(One Side Blocked)" : ""}
    Handicap: ${betData.handicap.lines} line ${betData.handicap.blocked ? "(One Side Blocked)" : ""}
    ${match.sportId == 1 ? `HT Removed: ${betData.htRemoved ? "Yes" : "No"}` : ""}
    Blocked: ${betData.teamWinsBlocked || "No"}
